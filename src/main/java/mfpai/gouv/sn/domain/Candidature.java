...
public class Candidature implements Serializable {
    ...
    public Candidature offreFormation(NomFiliere offreFormation) {
    ...
    public Candidature dateDebutOffre(LocalDate dateDebutOffre) {
    ...
    public Candidature dateFinOffre(LocalDate dateFinOffre) {
    ...
    public Candidature dateDepot(LocalDate dateDepot) {
    ...
    public Candidature resultat(Resultat resultat) {
    ...
    public Candidature formationInitiale(FormationInitiale formationInitiale) {
    ...
    public Candidature formationContinue(FormationContinue formationContinue) {
