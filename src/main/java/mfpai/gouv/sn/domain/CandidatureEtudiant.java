...
/**
 * A CandidatureEtudiant.
 */
@Entity
@Table(name = "candidature_etudiant")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CandidatureEtudiant implements Serializable {
    ...
    public CandidatureEtudiant id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public CandidatureEtudiant offreFormation(NomFiliere offreFormation) {
    ...
    public CandidatureEtudiant dateDebutOffre(LocalDate dateDebutOffre) {
    ...
    public CandidatureEtudiant dateFinOffre(LocalDate dateFinOffre) {
    ...
    public CandidatureEtudiant dateDepot(LocalDate dateDepot) {
    ...
    public CandidatureEtudiant resultat(Resultat resultat) {
    ...
    public CandidatureEtudiant etudiant(Etudiant etudiant) {
    ...
    public CandidatureEtudiant formationInitiale(FormationInitiale formationInitiale) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CandidatureEtudiant)) {
            return false;
        }
        return id != null && id.equals(((CandidatureEtudiant) o).id);
    }
