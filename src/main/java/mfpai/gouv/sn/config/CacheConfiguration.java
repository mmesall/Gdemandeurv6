...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, mfpai.gouv.sn.domain.Formation.class.getName() + ".demandeurs");
            createCache(cm, mfpai.gouv.sn.domain.Formation.class.getName() + ".eleves");
            createCache(cm, mfpai.gouv.sn.domain.Formation.class.getName() + ".etudiants");
            createCache(cm, mfpai.gouv.sn.domain.Formation.class.getName() + ".professionnels");
            ...
            createCache(cm, mfpai.gouv.sn.domain.Candidature.class.getName());
            ...
            createCache(cm, mfpai.gouv.sn.domain.Demandeur.class.getName() + ".candidatures");
            ...
            createCache(cm, mfpai.gouv.sn.domain.Eleve.class.getName() + ".candidatures");
            ...
            createCache(cm, mfpai.gouv.sn.domain.Etudiant.class.getName() + ".candidatures");
            ...
            createCache(cm, mfpai.gouv.sn.domain.Professionnel.class.getName() + ".candidatures");
            createCache(cm, mfpai.gouv.sn.domain.Agent.class.getName());
            createCache(cm, mfpai.gouv.sn.domain.ServiceMFPAI.class.getName());
            createCache(cm, mfpai.gouv.sn.domain.FormationInitiale.class.getName() + ".candidatures");
            createCache(cm, mfpai.gouv.sn.domain.FormationContinue.class.getName() + ".candidatures");
            createCache(cm, mfpai.gouv.sn.domain.FormationInitiale.class.getName() + ".candidatureElevs");
            createCache(cm, mfpai.gouv.sn.domain.FormationInitiale.class.getName() + ".candidatureEtudiants");
            createCache(cm, mfpai.gouv.sn.domain.FormationContinue.class.getName() + ".candidatureProfs");
            createCache(cm, mfpai.gouv.sn.domain.Eleve.class.getName() + ".candidatureElevs");
            createCache(cm, mfpai.gouv.sn.domain.Etudiant.class.getName() + ".candidatureEtudiants");
            createCache(cm, mfpai.gouv.sn.domain.Professionnel.class.getName() + ".candidatureProfs");
