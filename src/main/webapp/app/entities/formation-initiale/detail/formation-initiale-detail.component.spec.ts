...
describe('FormationInitiale Management Detail Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [FormationInitialeDetailComponent],
      providers: [
        {
          provide: ActivatedRoute,
          useValue: { data: of({ formationInitiale: { id: 123 } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load formationInitiale on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.formationInitiale).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
