...
export class EleveComponent implements OnInit {
  ...
  constructor(protected eleveService: EleveService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.eleves = [];
    ...
    this.eleveService
      ...
      .subscribe({
        next: (res: HttpResponse<IEleve[]>) => {
          ...
          this.paginateEleves(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
